...
const THEMATIC_NODES = [
  ...
  { id: 'arquitectura', title: 'Arquitectura', subtitle: 'Belle Époque & Palacios', desc: 'Un recorrido por el trazado de la ciudad, sus residencias neoclásicas, avenidas históricas y la monumentalidad del Frente Fluvial.', icon: Building2, image: '/antonio-berni.webp', route: '/temas/arquitectura' },
  { id: 'deportes', title: 'Deportes', subtitle: 'Génesis & Pasión Decana', desc: 'La cuna del fútbol argentino, la génesis de sus clubes centenarios y las epopeyas deportivas de la ciudad.', icon: Trophy, image: '/deporte.jpeg', route: '/temas/deportes' },
  { id: 'economia', title: 'Economía y Sociedad', subtitle: 'La Chicago Argentina', desc: 'La explosión agroexportadora, el auge portuario, los movimientos obreros y la transformación industrial.', icon: Landmark, image: '/economia.jpg', route: '/temas/economia' },
  { id: 'fotografia', title: 'Fotografía Histórica', subtitle: 'Memoria Visual', desc: 'Daguerrotipos, placas de vidrio y registros fotográficos inéditos que documentan la vida cotidiana desde 1860.', icon: Camera, image: '/aduana-rosario.webp', route: '/temas/fotografia' },
  ...
  { id: 'arqueologia', title: 'Arqueología Urbana', subtitle: 'Vestigios Ocultos', desc: 'El rescate de túneles, cimientos coloniales y hallazgos materiales ocultos bajo el casco histórico.', icon: Compass, image: '/inmersivo-ferrocarril.webp', route: '/temas/arqueologia' },
