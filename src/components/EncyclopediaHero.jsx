...
const THEMATIC_NODES = [
  ...
  { id: 'arquitectura', title: 'Arquitectura', subtitle: 'Belle Époque & Palacios', desc: 'Un recorrido por el trazado de la ciudad, sus residencias neoclásicas, avenidas históricas y la monumentalidad del Frente Fluvial.', icon: Building2, image: 'public/parque-españa.webp', route: '/temas/arquitectura' },
  ...
  { id: 'economia', title: 'Economía y Sociedad', subtitle: 'La Chicago Argentina', desc: 'La explosión agroexportadora, el auge portuario, los movimientos obreros y la transformación industrial.', icon: Landmark, image: 'https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?q=80&w=1200', route: '/temas/economia' },
